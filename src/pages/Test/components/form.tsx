    ...
    return (
        <div className={cls.spanTest}>
            <form action="#" method="get">
                ...
                <div>
                    <p>Telephone</p>
                    <input tabIndex={3} name="telephone" type="tel" />
                    Lorem <span>ipsum dolor sit amet</span>, consectetur
                    adipisicing elit. Itaque, recusandae!
                </div>
                <div>
                    <p>Gender</p>
                    <div>
                ...
                <div>
                    ...
                    <div>
                        <input tabIndex={6} name="bicycle" type="checkbox" />
                        Bicycle
                    </div>
                    <div>
                        <input
                ...
                <div>
                    ...
                    <div>
                        <input tabIndex={9} name="foto" type="file" />
                    </div>
                </div>
                <div>
                    <p>Favorite color</p>
